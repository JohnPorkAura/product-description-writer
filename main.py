"""
Product Description Writer — Descriptions that sell
...
DB_FILE      = "product_description_writer.db"
SYSTEM_PROMPT = "You are an expert Product Description Writer assistant. Enter product details and target customer. Get conversion-optimised product descriptions for your website or marketplace."

app = FastAPI(title="Product Description Writer")
...
<title>Product Description Writer</title>
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">Product Description Writer</div>
    <div class="auth-sub">Descriptions that sell</div>
    <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div class="hdr-left">
    <div class="logo">Product Description Writer</div>
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Product Description Writer</em><br>Descriptions that sell</h1>
    <p>Enter product details and target customer. Get conversion-optimised product descriptions for your website or marketplace. Built for users.</p>
  </div>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <button class="card-action" onclick="clearForm()">Clear</button>
        ...
        <div class="field">
      <label for="field-product_name">Product Name</label>
      <textarea id="field-product_name" placeholder="Enter product name..." required></textarea>
    </div>
    <div class="field">
      <label for="field-features">Features</label>
      <input type="text" id="field-features" placeholder="e.g. your features">
    </div>
    <div class="field">
  ...
  <footer>
    <div class="foot-note">Product Description Writer &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  systemPrompt:   "You are an expert Product Description Writer assistant. Enter product details and target customer. Get conversion-optimised product descriptions for your website or marketplace.",
  promptTemplate: "Product Name: {{product_name}}\\nFeatures: {{features}}\\nTarget Customer: {{target_customer}}\\nPlatform: {{platform}}",
  resultFormat:   'text', // text | list | steps
  resultConfig:   {"label": "Result", "copyable": true},
  inputs:         [{"id": "product_name", "label": "Product Name", "type": "textarea", "placeholder": "Enter product name...", "required": true}, {"id": "features", "label": "Features", "type": "text", "placeholder": "e.g. your features", "required": false}, {"id": "target_customer", "label": "Target Customer", "type": "text", "placeholder": "e.g. your target customer", "required": false}, {"id": "platform", "label": "Platform", "type": "select", "options": ["Google Ads", "Facebook / Instagram", "LinkedIn", "Twitter/X", "TikTok"], "required": false}],
};
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "Product Description Writer", "ai_ready": bool(GROQ_API_KEY)}
